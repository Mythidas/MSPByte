...
import { column, textColumn, numberColumn } from '@/features/data-table/components/DataTableColumn';
...
import { MicrosoftLicenseMetadata } from '@/integrations/microsoft/types';
