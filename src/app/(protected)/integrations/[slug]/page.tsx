  ...
  return (
    <div className="flex flex-col gap-4 size-full">
      ...
      <div className="flex flex-col size-full">
        <section className={`flex w-full h-40 items-center justify-center rounded-t-lg overflow-hidden shadow-md`} style={{ backgroundColor: source.data.color || "" }}>
          <img src={source.data.logo_url || ""} alt={`${source.data.name} Logo`} className="w-1/3 h-fit max-h-14 object-contain" />
        </section>
