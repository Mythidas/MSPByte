...
function ConnectedSitesCard({ sourceId }: { sourceId: string }) {
  const {
    data: { total, connected },
    isLoading,
  } = useAsync({
  ...
  return (
    <Card>
      ...
      <CardContent className="flex flex-col">
        ...
        <span className="text-sm text-muted-foreground">of {total} total sites</span>
        <Progress value={total / connected} />
      </CardContent>
    </Card>
  );
}
