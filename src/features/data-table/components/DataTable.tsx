...
import { DataTableFilters } from '@/features/data-table/components/DataTableFilters';
import { DataTableFooter } from '@/features/data-table/components/DataTableFooter';
import {
  DataTableColumnDef,
  DataTableFetcher,
  DataTableFilter,
  DataTableAction,
} from '@/features/data-table/types/table';
